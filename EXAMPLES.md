...
```bash
# 1️⃣1️⃣ Мелодия "Марш" (военный марш)
tone 330 150 -p 100 && tone 330 150 && tone 330 150 && tone 264 200

# 1️⃣2️⃣ Звук успеха (3 подряд идущих ноты вверх)
tone 400 100 && tone 500 100 && tone 600 100

# 1️⃣3️⃣ Звук неудачи (опускающиеся ноты)
tone 600 100 && tone 500 100 && tone 400 100

# 1️⃣4️⃣ Первые ноты гимна
tone 440 200 && tone 494 200 && tone 523 200

# 1️⃣5️⃣ Колокольный звон (высокие частоты)
tone 8000 200 && tone 7000 150 && tone 6000 150

# 1️⃣6️⃣ Звук xylophone (щипковый инструмент)
tone 2640 80 && tone 2200 80 && tone 1760 80 && tone 1320 80

# 1️⃣7️⃣ Музыкальная лестница вверх (8 нот)
for f in 262 294 330 349 392 440 494 523; do tone $f 100; done

# 1️⃣8️⃣ Звук "да-да-да-дааа" (от Битлов)
tone 400 100 && tone 400 100 && tone 400 100 && tone 200 300
```

### Специальные эффекты
```bash
# 1️⃣9️⃣ Фейерверк (быстрые звуки вверх и вниз)
for i in 1 2 3; do tone 1000 0 -c 5000; tone 5000 0 -c 1000; done

# 2️⃣0️⃣ Взрыв (низкая частота, нарастающий объём)
tone 100 300 -p 20 && tone 100 200 -p 50 && tone 100 100 -p 100

# 2️⃣1️⃣ Волна или сирена (медленный chirp)
tone 1000 1000 -c 5000

# 2️⃣2️⃣ UFO приближение (волны нарастающие)
tone 2000 100 && tone 2500 100 && tone 3000 100 && tone 3500 100

# 2️⃣3️⃣ UFO отдаляется (волны нисходящие)
tone 3500 100 && tone 3000 100 && tone 2500 100 && tone 2000 100

# 2️⃣4️⃣ Звук телепортации (быстрый взлёт и падение)
tone 1000 0 -c 8000 && tone 8000 0 -c 1000

# 2️⃣5️⃣ Лазер (быстрый звук вверх)
tone 1000 200 -c 5000

# 2️⃣6️⃣ Выстрел (быстрое нарастание и спад)
tone 500 50 && tone 0 30
```

### Звуки оборудования и устройств
```bash
# 2️⃣7️⃣ Звук загрузки (3 ступеньки)
tone 800 100 && tone 1200 100 && tone 1600 100

# 2️⃣8️⃣ Звук выключения (опускающийся звук)
tone 2000 300 -c 200

# 2️⃣9️⃣ Звук включения (поднимающийся звук)
tone 200 300 -c 2000

# 3️⃣0️⃣ Печать/сканирование (ритмичные звуки)
for i in 1 2 3 4; do tone 1500 50; sleep 0.1; done

# 3️⃣1️⃣ Кодовый замок открыт (успешный ввод)
tone 1200 100 && tone 1500 100 && tone 1800 100

# 3️⃣2️⃣ Кодовый замок ошибка (резкий низкий звук)
tone 300 200
```

### Ритмические паттерны
```bash
# 3️⃣3️⃣ Сердцебиение (два быстрых звука + пауза)
for i in 1 2 3 4; do tone 1000 50 && tone 1200 50; sleep 0.3; done

# 3️⃣4️⃣ Азартный ритм (барабаны)
tone 2000 50 && sleep 0.1 && tone 2000 50 && sleep 0.2 && tone 2000 100

# 3️⃣5️⃣ Маячный ритм (один длинный + два коротких)
tone 2000 300 && tone 3000 100 && tone 3000 100

# 3️⃣6️⃣ Тик-так часов
tone 1000 100 && sleep 0.2 && tone 1200 100

# 3️⃣7️⃣ Morse код (точка-точка-тире): SOS
tone 1000 100 && sleep 0.1 && tone 1000 100 && sleep 0.1 && tone 1000 100 && sleep 0.3 && tone 1000 300 && sleep 0.1 && tone 1000 300 && sleep 0.1 && tone 1000 300

# 3️⃣8️⃣ Звон будильника (повторяющиеся пары)
for i in 1 2 3 4 5; do tone 2000 50 && tone 0 20 && tone 2000 50 && sleep 0.1; done
```

### Экстремальные и необычные звуки
```bash
# 3️⃣9️⃣ Самый низкий звук (subsonic гудок)
tone 20 500

# 4️⃣0️⃣ Самый высокий писк (ultrasonic)
tone 15000 500

# 4️⃣1️⃣ Звуковой диапазон (от 50 до 8000 Гц)
for f in 50 200 500 1000 2000 5000 8000; do tone $f 100; done

# 4️⃣2️⃣ Тремоло (модулирующийся звук разной громкости)
for v in 20 50 80 100 80 50 20; do tone 2000 50 -p $v; done

# 4️⃣3️⃣ Механический робот (квадратный звук)
tone 1000 100 && tone 0 30 && tone 1000 100 && tone 0 30 && tone 1000 200

# 4️⃣4️⃣ Зуммер (жужжание на двух частотах)
tone 900 200 && tone 1100 200

# 4️⃣5️⃣ Звук монитора перед срывом (высокочастотное скрежетание)
for f in 7000 7500 8000 7500 7000; do tone $f 100; done
```
