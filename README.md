...
## Поиск пути к баззеру (если автоопределение не сработало)
...
### 📁 Файл конфигурации `/etc/tone.conf`
...
| `spin_threshold_us` | число (мкс) | Порог переключения между sleep и spin-lock. Default: 100 микросекунд. |
